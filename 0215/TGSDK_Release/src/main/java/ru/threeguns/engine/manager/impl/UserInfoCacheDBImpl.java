...
public class UserInfoCacheDBImpl extends Module implements UserInfoCache {
	private static final String DB_NAME = "TG_COMMON_DB";
	private static final String TABLE_NAME = "TG_USERS";
	private static final String ACTIVEUSER_TABLE_NAME = "TG_ACTIVE_USER";
