...
public class FeedbackDialogFragment extends HFragment {
    ...
    private String buildUrl(String path) {
        ...
        url.append(NetworkUtil.getHostAddress(null)).append(path).append("/?")
                .append("user_id="+Module.of(UserCenter.class).getUserId())
                .append("&token="+Module.of(UserCenter.class).getToken())
                .append("&appid="+Module.of(TGController.class).appId)
                .append("&sdklang="+Module.of(TGController.class).appLanguage);
        return url.toString();
    }
